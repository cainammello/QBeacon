...
public class BeaconActivity extends AppCompatActivity implements BeaconFinder.BeaconFinderListener {

    protected static final String TAG = "DEBUG-BEACON-ACTIVITY";
    ...
    public void onScanStarted() {
        delayCount = System.currentTimeMillis();
    }
    ...
    public void onBeaconFinded(Beacon b, String uuid) {
        teste.setScanInterval(System.currentTimeMillis() - delayCount);
        delayCount = System.currentTimeMillis();
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                teste.setLoadInfoInterval(System.currentTimeMillis() - delayCount);
                teste.save();
                finish();
